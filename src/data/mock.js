  ...
  projects: [
    {
      ...
      category: "ecommerce",
      title: "Manojitos",
      description: "Plataforma E-commerce + ERP/CRM con IA integrada para floristería nacional.",
  ...
  projects: [
    {
      ...
      category: "ecommerce",
      title: "Manojitos",
      description: "E-commerce + ERP/CRM platform with integrated AI for national flower shop.",
      image: "/images/manojitos-dashboard.png",
      color: "#FF6B6B",
    },
    {
...
export const caseStudies = [
  {
    ...
    title: "Manojitos",
    subtitle: "Plataforma E-commerce + ERP/CRM con IA integrada para floristería nacional.",
    client: "Manojitos · Floristería",
    location: "Venezuela",
    year: "2025",
    timeline: "8 semanas",
    color: "#FF6B6B",
    heroImage: "/images/manojitos-dashboard.png",
    challenge: "La floristería manejaba sus ventas por WhatsApp con procesos 100% manuales. Sin control de inventario, sin registro de deudas, sin seguimiento de clientes y sin forma profesional de mostrar su catálogo de productos.",
    ...
    results: "La floristería pasó de gestión 100% manual a un sistema digitalizado completo. El tiempo de procesamiento de pedidos se redujo un 70%. Los clientes ahora pueden comprar, rastrear pedidos y usar créditos desde su portal personal.",
    ...
    features: [
      ...
      "Sistema de deudas y créditos entre floristería y clientes",
